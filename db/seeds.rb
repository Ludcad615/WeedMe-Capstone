...
puts "Creating Reviews"
 ...
 Review.create!(description: "Perfect High. Didnt make me feel sleepy", strain_id: 11, user_id: 1)

 Review.create!(description: "The color on this strain is out of this world", strain_id: 12, user_id: 1)   
